...
semantic HTML gives meaning to html tags on a web page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
display block will extend to the end of the page and will have its own length. inline will display on the same, current line.

3. What are the 4 areas of the box model?
content,padding, border, margin 

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
the align-items property works always on the cross-axis

5. Explain why git is valuable to a team of developers.
because it keeps many different versions of old code well organized.
